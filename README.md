...
- Publication link: https://papers.ssrn.com/sol3/papers.cfm?abstract_id=6261138
  
**TL;DR**:  *We present a novel approach of jointly forecasting covariance matrix and returns using deep ensemble models and feeding the forecasts as inputs to a classical Markowitz model.* 
